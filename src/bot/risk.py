...
def volatility_target_position(
    ...
    """Scale position size so that realised volatility equals target_vol; clips output to [0, 1]."""
...
def apply_risk_management(
    ...
    """Zero out positions and returns whenever the equity drawdown breaches max_drawdown."""
    df = df.copy()
